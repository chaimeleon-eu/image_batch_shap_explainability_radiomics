...
class SHAPAnalysis:
    ...
    def __init__(self, model, store_folder_path = "shap_results", feature_names = None):
        ...
        self.path_global = os.path.join(self.folder_path, "global_summary_plots")
        self.path_local = os.path.join(self.folder_path, "local_plots")
        self.path_dependence = os.path.join(self.folder_path, "dependence_plots")
                ...
                for j, feature in enumerate(top_features):
                    ...
                    if no_of_interactions > 0:
                        ...
                        for k, interaction in enumerate(interactions):
                            ...
                            shap.dependence_plot(feature, self.shap_values[...,idx].values, self.data, interaction_index=interaction, show=False)
        ...
        # If the problem is not multiclass, generate dependence plots without considering class
            ...
            for j, feature in enumerate(top_features):
                ...
                if no_of_interactions > 0:
                    ...
                    for k, interaction in enumerate(interactions):
                        # Generate dependence plot considering interaction
                        shap.dependence_plot(feature, self.shap_values.values, self.data, interaction_index=interaction, show=False)
                        # Save the plot to a file
